...
Pour ajouter un produit vous devez modifier le fichier présent dans le dossier [data/produits.csv](https://github.com/jb2brest/tpiut/blob/2024-Lannion-GA1-MARTIN-BEAUPEL/data/produits.csv) en rajoutant une ligne sous la forme:
```csv
